    ...
    setup() {
        ...
        const postNewHotel = async () => {
            try {
                ...
                const nit = document.getElementById('first-name').value;
                const nombre = document.getElementById('last-name').value;
                const ciudad = document.getElementById('country').value;
                const maxHabitaciones = document.getElementById('tentacles').value;
                const direccion = document.getElementById('street-address').value;

                // Ahora puedes utilizar estos valores como desees, por ejemplo, imprimirlos en la consola
                console.log('Valores del formulario:');
                console.log('NIT:', nit);
                console.log('Nombre:', nombre);
                console.log('Ciudad:', ciudad);
                console.log('Máx. Habitaciones:', maxHabitaciones);
                ...
                const newHotel = {
                    ...
                    "nit": nit,
                    "address": direccion,
                    "num_rooms": maxHabitaciones
                };
                const response = await axios.post('http://146.190.32.176/diplomado/api/hotels', newHotel);
        ...
        return {
            ...
            closeModalVerHotel,
            showModalVerHotel,
            isShowModalEditarHotel,
            closeModalEditarHotel,
            showModalEditarHotel,
            isShowModalEliminarHotel,
            closeModalEliminarHotel,
            showModalEliminarHotel,
            isShowModal,
            closeModal,
            showModal,
            hoteles,
...
<template>
    <div>
            ...
            <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                ...
                <div
                    ...
                    <div class="w-full">
                        <form class="flex items-center">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="simple-search" placeholder="Buscar Hoteles" required=""
                    ...
                    <div
                        ...
                        <button type="button"
                            class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                            @click="showModal">
                ...
                <form>
                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="sm:col-span-3">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">NIT</label>
                            <div class="mt-2">
                                <input type="text" name="first-name" id="first-name" placeholder="27220950-4"
                        ...
                        <div class="sm:col-span-3">
                            <label for="last-name" class="block text-sm font-medium leading-6 text-gray-900">Nombre</label>
                            <div class="mt-2">
                                <input type="text" name="last-name" id="last-name" placeholder="Conquistador"
                        ...
                        <div class="col-span-full">
                            <label for="street-address"
                                class="block text-sm font-medium leading-6 text-gray-900">Dirección</label>
                            <div class="mt-2">
                                <input type="text" name="street-address" id="street-address" placeholder="Crr 9B #15-66"
        ...
        <Modal :size="size" v-if="isShowModalEditarHotel" @close="closeModalEditarHotel">
            ...
            <template #footer>
                <div class="flex justify-between">
                    <button @click="closeModalEditarHotel" type="button"
                        class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                        Cerrar
                    </button>
                    <button @click="closeModalEditarHotel" type="button"
